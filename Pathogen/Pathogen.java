// Original file by Sean Szumlanski
// Altered by Grant Hendrickson (gr251825)
// COP 3503 Fall 2022
...
public class Pathogen
{
    ...
    public static HashSet<String> findPaths(char [][] maze)
    {
        ...
        // Create a stack that keeps track of the current path taken
        Stack<Character> path = new Stack<>();

        // Create a HashSet to store all the possible paths to the exit
        ...
        // Let's goooooooooo!!
        solveMaze(maze, visited, path, pathSet, startRow, startCol, height, width);

        return pathSet;
    }

    private static boolean solveMaze(char [][] maze, char [][] visited,
                                            Stack<Character> path, HashSet<String> pathSet,
                                            ...
                                            int height, int width)
    {
        ...
        char [] moveChars = new char[] {'l', 'r', 'u', 'd'};
        ...
        for (int i = 0; i < moves.length; i++)
        {
            ...
            if (solveMaze(maze, visited, path, pathSet, newRow, newCol, height, width))
                return true;
                                    ...
                                    int row, int col, int height, int width)
    {
        ...
        if(maze[row][col] == WALL || maze[row][col] == COVID || 
    ...
    public static String pathToString(Stack<Character> path)
    {
        ...
        // Create a new Stack to store the original state of the stack
        ...
        // place the first char in the string
        if (!reverse.isEmpty())
            builder.append(reverse.pop());

        // place the remaining chars in the string with spaces before them
        ...
        // Recover the original state of the stack
        path.addAll(temp);
